    ...
    echo "<br /><p class='cufon'>用户名只能是英文字母、数字和_且第一位必须是字母或数字！</p>";
	 ...
	 if($num[0] = 0){
	  ...
	  echo "<script>";
		...
		require_once("yucmedia.php");//引用yucmedia.php文件 
  ...
  <tr>
    <td width="439" bgcolor="#3366FF" class="lChoose"><form action="" method="post"> 
      ...
      <table width="363" height="124" border="0" align="center">
        <tr>
        <td width="93" class="LoginInfo" scope="col"><font class="cufon">用户名</font></td>
      ...
      <tr>
        ...
        <td colspan="2"><label for="yzm"></label>
          <input name="yzm" placeholder="单击显示验证码" type="text" class="fTextBox" id="yzm" size="35" maxlength="16" />
